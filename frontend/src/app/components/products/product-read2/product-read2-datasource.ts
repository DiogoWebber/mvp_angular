  ...
  private getSortedData(data: Product[]): Product[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'id':
          // Check if a.id and b.id are defined before comparing
          if (a.id !== undefined && b.id !== undefined) {
            return compare(a.id.toString(), b.id.toString(), isAsc);
          } else {
            // Handle cases where either a.id or b.id is undefined
            return 0; // or handle as needed in your specific logic
          }
        default:
          return 0;
      }
